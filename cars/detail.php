...
//read related cars
$sql1="SELECT * FROM `cars` WHERE `category_id` =?  &&  `id` !=? ";
$stmtRel=$conn->prepare($sql1);
$stmtRel->execute([$categoryId, $id]);
...
<body>
  ...
  <!-- Related Car start -->
 <?php include_once("relatedcars.php") ?>
